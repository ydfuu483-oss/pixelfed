...
@section('section')
	...
	<p class="lead">Please try again later, or consider <a href="https://pix.org/servers">joining a different Pix instance</a>.</p>
	@else
	<p class="lead">We do not have a limit on how many users can join our instance.</p>

	<p class="lead">If this instance isn't for you, consider <a href="https://pix.org/servers">joining a different Pix instance</a>.</p>
	@endif
@endsection
